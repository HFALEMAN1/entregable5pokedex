      ...
      <section className="pokemonId">
        ...
        <section className="pokemonId__features">
          ...
          <div className="pokemonId__feature">
            ...
            <p className="pokemonId__feature-value">{dataPokemon?.id.height}</p>
          </div>
        </section>
          ...
          <div className="pokemonId__info-container">
            ...
            <div className="pokemonId__info-data">
              {dataPokemon?.types.map((type) => (
                <p className={`pokemonId__info-value bg-${type.type.name}`} key={type.type.name}>
                  {type.type.name}
                </p>
              ))}
              <p></p>
            ...
            {dataPokemon?.stats.map((stat) => (
              <div className="pokemonId__stat">
                ...
                <div className="pokemonId__stat-bar">
                  <div style={{width: getPercentBarProgress(stat.base_stat) }} className="pokemonId__stat-barProgeress"></div>
                </div>
              </div>
            ))}
          </div>
